...
class SmartLoader:
    '''
    Docstring for SmartLoader
    Handle loading of various file types for the Agent 1.
    Strategies:
    ...
    def load_image(file_path: str) -> types.Part:
        """Load an image for Gemini Vision."""
        try:
    ...
    def process_file(self, file_path: str) -> Union[str, types.Part, None]:
        ...
        if not os.path.exists(file_path):
            raise FileNotFoundError(f"File not founder: {file_path}")
